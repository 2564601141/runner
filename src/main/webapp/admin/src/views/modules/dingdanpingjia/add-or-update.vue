<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="评价星级" prop="pingjiaxingji">
          <el-select v-model="ruleForm.pingjiaxingji" placeholder="请选择评价星级">
            <el-option
                v-for="(item,index) in pingjiaxingjiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="评价星级" prop="pingjiaxingji">
	      <el-input v-model="ruleForm.pingjiaxingji"
                placeholder="评价星级" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xingming = true;
          ...
          if(o=='pingjiaxingji'){
            this.ruleForm.pingjiaxingji = obj[o];
	    this.ro.pingjiaxingji = true;
            continue;
          }
          if(o=='pingjianeirong'){
      ...
      this.$http({
		...
		if(json.nicheng!=''&&json.nicheng){
          ...
          this.$message.error(data.msg);
            ...
            this.pingjiaxingjiOptions = "一星,二星,三星,四星,五星".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
