...
public class ZaixianxiadanController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,ZaixianxiadanEntity zaixianxiadan, 
		HttpServletRequest request){

		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("xuesheng")) {
			zaixianxiadan.setXuehao((String)request.getSession().getAttribute("username"));
		}
